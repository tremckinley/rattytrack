...
export default function SearchableLegislators({ legislators, initialStatus, emptyState }: SearchableLegislatorsProps) {
    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end mb-6">
                ...
                <div className="flex gap-2 bg-card rounded-lg p-1 border border-border">
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${initialStatus === 'active'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${initialStatus === 'inactive'
                                ? 'bg-primary text-primary-foreground'
                                : 'text-muted-foreground hover:text-foreground'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${initialStatus === 'all'
                                ? 'bg-primary text-primary-foreground'
                                : 'text-muted-foreground hover:text-foreground'
                            }`}
                    >
            ...
            {legislators.length === 0 && emptyState ? (
                ...
                <div className="card text-center py-12">
                    <p className="text-foreground text-lg mb-2">No matching legislators found</p>
